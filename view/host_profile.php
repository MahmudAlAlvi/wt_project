...
<div style="background-color: white; padding: 10px;">
  ...
  <a href="host_picture.php" style="color: black; text-decoration: none; font-weight: bold;">Change Profile Picture</a>&nbsp;&nbsp;&nbsp;&nbsp;
  <span style="color: red;">|</span>&nbsp;&nbsp;&nbsp;&nbsp;
 
  <a href="host_home.php" style="color: black; text-decoration: none; font-weight: bold;">Back to Homepage</a>&nbsp;&nbsp;&nbsp;&nbsp;
  <span style="color: red;">|</span>&nbsp;&nbsp;&nbsp;&nbsp;
...
<div style="margin-top: 75px; text-align: center;">
    <table style="width: 60%; border-collapse: collapse; border: 2px solid #333; margin: 0 auto;">
        <tr>
            <td style="border-right: 2px solid #333; padding: 10px; font-weight: bold; width: 50%;">Host Information</td>
        ...
        <tr>
            ...
            <img src="../assets/img/hands.jpg" alt="Picture" style="width: 150px; height: 150px;">
</div>
