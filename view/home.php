...
?>
    ...
    <!-- <a href="../controller/logout.php" style="text-decoration: none;">
      <button style="background-color: white; border: none; cursor: pointer;">LOG OUT</button>
    </a> -->
  </div>
</div>
...
<div style="background-color: white; padding: 10px;">
  <a href="home.php" style="color: red; font-weight: bold; text-decoration: none;">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <a href="contact_us_logout.php" style="color: black; text-decoration: none; font-weight: bold;">Contact us</a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="search_logout.php" style="color: black; text-decoration: none; font-weight: bold;">Search</a>
