...
if(isset($_POST['submit'])) {
    ...
    if(in_array($file_extension, $allowed_extensions)) {
        ...
        if(move_uploaded_file($file_tmp, $target_file)) {
            $adminUsername = "admin";  
            $profilePicturePath = $target_file; // Here we store the full path

            $updateResult = updateProfilePicture($adminUsername, $profilePicturePath);  // `updateProfilePicture` ফাংশনটি আপনার model ফাইলে থাকা উচিত

            if($updateResult) {
                // echo "Image uploaded and path updated successfully!";
            } else {
...
<div style="margin-top: 60px; margin-left: 20%; margin-right: 20%; text-align: center;">
    ...
    <div style="margin-top: 30px;">
        <form method="post" action="changepicture.php" enctype="multipart/form-data" onsubmit="return validateForm()">
