...
<div style="background-color: blue; padding: 10px; display: flex; justify-content: space-between; align-items: center;">
...
<div style="background-color: white; padding: 10px;">
  ...
  <!-- Media Dropdown -->
  <details style="display: inline-block;">
    <summary style="font-weight: bold;">Request For Hosting</summary>
    <div style="background-color: gray; min-width: 200px; padding: 10px;">
      <a href="#" style="color: black; text-decoration: none; font-weight: bold; display: block;">Concert</a>
      <a href="#" style="color: black; text-decoration: none; font-weight: bold; display: block;">Workshop</a>
      <a href="#" style="color: black; text-decoration: none; font-weight: bold; display: block;">Exhibition</a>
    </div>
  </details>
  
  &nbsp;&nbsp;&nbsp;&nbsp;
  
  <a href="#" style="color: black; text-decoration: none; font-weight: bold;">Your Event</a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="#" style="color: black; text-decoration: none; font-weight: bold;">History</a>
